            ...
            <form action="{{route('role_store')}}" method="post">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="display_name" class="form-control" id="describe" id="" cols="30" rows="5"></textarea>
                        @error('describe')
                            <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
                    ...
                    <div class="card border-primary mb-3 col-md-12">
                       ...
                       <div class="row">
                            ...
                            <div class="card-body text-primary col-md-3">
                                <h5 class="card-title">
                                <label for="">
                                    <input type="checkbox" name="permission_id[]" value="{{$permissionsChildrentItem->id}}" class="checkbox_childrent">
                                </label>
